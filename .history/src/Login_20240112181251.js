import {View, TextInput, TouchableOpacity, StyleSheet,Image,Text,showPassword,password, Button} from 'react-native';
...
const Login = () => {
  ...
  return (
    <View style={mystyle.body}>
      ...
      <View>
        <Button title="Sign In" onPress={''} style={mystyle.button1} />
      </View>
    </View>
  );
};
