...
const Login = props => {
  ...
  const checklogin = async () => {
    try {
      ...
      // lưu  password  trong  account
      setAccount({...response, password});
      setUserdata({Name, password, name: response.user.name});
      setIsLogin(true);
    } catch (error) {
  ...
  return (
    <View style={mystyle.body}>
      <View style={mystyle.head}>
        ...
        <View style={[mystyle.iconContainer, !isPassVaild && mystyle.error]}>
          <TextInput
            placeholderTextColor="#828282"
        ...
        <TouchableOpacity style={mystyle.donacc} onPress={reg}>
